...
(
    ...
    hub_name    varchar(100)     NOT NULL DEFAULT '',
    country_id  varchar(100)     NOT NULL DEFAULT '',
    district_id varchar(100)     NOT NULL DEFAULT '',
    station_id  varchar(100)     NOT NULL DEFAULT '',
    hub_phone_1 varchar(100)     NOT NULL DEFAULT '',
    hub_phone_2 varchar(100)     NOT NULL DEFAULT '',
    hub_email   varchar(100)     NOT NULL DEFAULT '',
    hub_address varchar(100)     NOT NULL DEFAULT '',
